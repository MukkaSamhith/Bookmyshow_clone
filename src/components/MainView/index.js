...
class View extends Component{
  ...
  state = {p:[],is:true,count:0,s:"",n1:'',n2:0,n3:'',n4:'',n5:'',n6:0,n7:'',n8:'',search:''}
  ...
  getData = async()=>{
    ...
    this.setState({p:x,count:data.length})
  }
  ...
  sendOf=async()=>{
    ...
    const response = await fetch("http://localhost:3005/hollywood/",options)
  }
